...
In the remaining of this section, we present, based on the example from Section~\ref{sec:example}, how \contractjdoc{} supports a mixed approach, which combines textual documentation with formal notation.
