...
\title{Investigating the Trade-offs between Automatic Checking and Understandability in Java API Documentation}

\titlerunning{Investigating the Trade-offs between Automatic Checking and Understandability in Java API Documentation}
